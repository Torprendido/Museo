...
@WebServlet(name = "obrasReporte.pdf", urlPatterns = {"/obrasReporte.pdf"})
public class ObrasReporte extends HttpServlet {

    private final String reportSource = "/report/obrasReporte.jasper";
