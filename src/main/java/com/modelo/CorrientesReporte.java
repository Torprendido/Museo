...
@WebServlet(name = "corrientesReporte.pdf", urlPatterns = {"/corrientesReporte.pdf"})
public class CorrientesReporte extends HttpServlet {

    private final String reportSource = "/report/corrientesReporte.jasper";
